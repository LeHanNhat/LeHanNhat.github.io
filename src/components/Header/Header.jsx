...
const Header = () => {
  ...
  const checkShippingStatus = async (id) => {
    ...
    const handleOrder =()=>{
        navigation("/lehannhat.github.io/product/cart_detail");
    }
    const handleToList =(category)=>{
        navigation(`/lehannhat.github.io/product/all/${category.name}`,{state:{id:category.id}});
    }
    const handleToSub=(sub,category)=>{
        navigation(`/lehannhat.github.io/product/all/${category.name}?collection=${sub.name}`,{state:{subId:sub.id, id:category.id}});
    }
    useEffect(() => {
        ...
        <header>
            <div className="header__inner">
                ...
                <div className="header_nav">
                    <ul>
                        <li>
                            <a href="/lehannhat.github.io/product/all">Clothes</a>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-md-3">
                                            <p>Theo Sản Phẩm</p>
                                            <ul>
                                                <li><a href="/lehannhat.github.io/product/all">Tất cả</a></li>
                                    ...
                                    <div className="row" >
                                        <div className="col-md-12">
                                            <ul>{brand && brand.map((b) => (
                                                <li><a href="/lehannhat.github.io/product/all">{b.name}</a></li>
                                            ))}
                            ...
                            <ul className="sub-menu" style={{ width: "180px" }}>
                                <div className="container">
                                    <div className="row" >
                                        <div className="col-md-12">
                                            <ul>
                                                <li><a href="/lehannhat.github.io/product/all">About US</a></li>
                                                <li><a href="">FAQ</a></li>
                ...
                <div className="header__actions">
                    ...
                    <div className="header-actions__button">
                        <Link to={"/lehannhat.github.io/user/info"} className="user">
                            <i class="fa-solid fa-user"></i></Link>
                        <ul style={{ width: "100px" }}>
                            <li  className="profile" onClick={() => navigation("/lehannhat.github.io/user/info")}><Link>{(username !== null) ? (username) : ("no-data")}</Link></li>
                            {(username !== null) ? (<li className="logout" style={{marginBottom:"0"}}  onClick={handleClickOpen}><Link>Log out</Link></li>) : (<li className="logout" style={{marginBottom:"0"}}><Link to={"/lehannhat.github.io/authentication/signIn"}>Log In</Link></li>)}
                                ...
                                <div className="header-actions-cart-popup__inner">
                                    <div className="header-actions-cart-popup__wrapper">
                                        <div className="header-actions-cart-popup__header">
                                            ...
                                            <a href="/lehannhat.github.io/product/cart_detail">Watch All</a>
                                        </div>
                                        {length > 0 ? (
